...
$experience = [
	[
        ...
        'description' => 'Ответственный: соблюдаю дедлайны, помогаю разработчикам, забочусь о качестве продукта',
    ],
    	[
    	'specialization' => "Middle",
        'dateStart' => '18.10.2020',
        'dateEnd' => '20.12.2021',
        'description' => 'Разработал систему автотестов для облачного сервиса — теперь информация об ошибках приходит разработчикам в понятных отчётах',
    ],
	[
    	'specialization' => "Junior ",
        'dateStart' => '15.06.2020',
        'dateEnd' => '18.12.2021',
        'description' => 'Нашёл ошибки в интерфейсе и серверной логике — теперь сайт загружается на 10% быстрее',
    ],
];
